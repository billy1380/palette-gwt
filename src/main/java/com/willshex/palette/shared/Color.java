...
public class Color {
    ...
    public static void RGBToHSV(int red, int green, int blue, float hsv[]) {
        ...
        ColorUtils.RGBToHSV(red, green, blue, hsv);
    }
    ...
    */
    public static int HSVToColor(int alpha, float hsv[]) {
        ...
        return ColorUtils.setAlphaComponent(ColorUtils.HSVToColor(hsv), alpha);
    }

    /**
     * Converts color ARGB integer into an HTML/CSS string #xxxxxx
     * @param color
     * @return
     */
    public static String toHtmlColor(int color) {
      StringBuilder sb = new StringBuilder("#");
      sb.append(Integer.toHexString(color & 0x00FFFFFF));
